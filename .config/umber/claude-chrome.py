...
write_atomic(f"{TD}/umber.json", json.dumps({"name":"Umber","base":"dark","overrides":{
    "userMessageBackground":dark_box,"userMessageBackgroundHover":dark_hover,
    "inverseText":D["15"],"briefLabelYou":dark_label}}, indent=2))
write_atomic(f"{TD}/umber-light.json", json.dumps({"name":"Umber Light","base":"light","overrides":{
    "userMessageBackground":light_box,"userMessageBackgroundHover":light_hover,
    "inverseText":L["0"],"briefLabelYou":light_label}}, indent=2))
